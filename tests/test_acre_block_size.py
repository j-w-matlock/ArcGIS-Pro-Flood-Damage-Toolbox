...
def test_acre_block_size_uses_square_for_30m_cells():
    ...
    assert acres == pytest.approx(0.888, rel=0.15)


@pytest.mark.parametrize(
    "cell_area, expected_cells",
    [
        (0.1, 9),  # 0.1-acre pixels aggregate to a 3x3 square (~0.9 acres).
